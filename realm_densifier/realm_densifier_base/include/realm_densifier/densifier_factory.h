...
#include <realm_densifier/densifier_IF.h>
#include <realm_densifier/densifier_settings.h>
#include <realm_densifier/densifier_dummy.h>

#ifdef USE_CUDA
  #include <realm_densifier/plane_sweep.h>
#endif
